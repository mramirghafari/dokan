$(document).ready(function () {
    ...
    $("#basic-datatable").DataTable({
        keys: !0,
        language: {paginate: {previous: "<i class='arrow_carrot-right'>", next: "<i class='arrow_carrot-left'>"}},
    ...
    var a = $("#datatable-buttons").DataTable({
        order: [[0, 'desc']],
        pageLength: 100,
        lengthMenu: [[200, 100, 50, 25, 10, 5], [200, 100, 50, 25, 10, 5]],
        buttons: ["copy", "print"],
        language: {paginate: {previous: "<i class='arrow_carrot-right'>", next: "<i class='arrow_carrot-left'>"}},
        drawCallback: function () {
            $(".dataTables_paginate > .pagination").addClass("pagination-rounded")
    ...
    $("#selection-datatable").DataTable({
        ...
        language: {
            paginate: {
                previous: "<i class='arrow_carrot-right'>",
                next: "<i class='arrow_carrot-left'>"
            }
        }, drawCallback: function () {
            $(".dataTables_paginate > .pagination").addClass("pagination-rounded")
