...
let isRtl = window.Helpers ? window.Helpers.isRtl() : (document.documentElement.getAttribute('dir') === 'rtl'),
    isDarkStyle = window.Helpers ? window.Helpers.isDarkStyle() : document.documentElement.classList.contains('dark-style'),
    menu,
    animate,
