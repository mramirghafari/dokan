                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <form class="row">
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            <label class="form-label" for="multicol-first-name">مقدار مورد نیاز (واحد محصول)</label>
                                            <input class="form-control" id="multicol-first-name" placeholder="مقدار ای تعدادش" type="number"/>
                                        </div>
                                        <button class="btn btn-primary" type="submit">ثبت درخواست تولید</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-datatable table-responsive pt-0">
                                    <table class="datatables-direct-basic table">
                                        ...
                                        <tr>
                                            ...
                                            <td>1600 عدد</td>
                                            <td>
                                                <span class="badge  bg-label-success">تولید شده</span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
