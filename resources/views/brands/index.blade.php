...
<head>
    ...
    <title>برند ها - دکان دارمینو</title>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <form action="{{ route('brands.store') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                            <label class="form-label" for="title">عنوان برند</label>
                                            <input type="text" class="form-control" name="title" id="title" placeholder="نام برند">
                                        </div>
                                    ...
                                    <table class="datatables-direct-basic table">
                                        ...
                                        @foreach ($brands as $brand)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('brands.edit',$brand->id) }}" style="font-size:20px;float: right;margin-left:5px"><x-ui.icon name="fa-edit" /></a>
...
<script>
    ...
    $('.basicdata .brands').addClass('active open')
    // datatable (jquery)
    $(function () {
        var
