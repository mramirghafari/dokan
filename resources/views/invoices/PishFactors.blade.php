...
<script src="{{ asset('assets/') }}/vendor/js/helpers.js"></script>
    ...
    @if (auth()->user()->id == 1 && !isset($listKey))
        <script src="{{ asset('assets/vendor/libs/tableexport/tableExport.min.js') }}"></script>
        <script src="{{ asset('assets/vendor/libs/tableexport/jspdf.umd.min.js') }}"></script>
        <script src="{{ asset('assets/vendor/libs/bootstrap-table/bootstrap-table.min.js') }}"></script>
        <script src="{{ asset('assets/vendor/libs/bootstrap-table/bootstrap-table-export.min.js') }}">
        </script>
        <script src="{{ asset('assets/vendor/libs/bootstrap-table/bootstrap-table-locale-all.min.js') }}"></script>
    @endif
