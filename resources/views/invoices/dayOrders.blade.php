...
<head>
    ...
    <title>سرجمع سفارشات روزانه - دکان دارمینو</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="py-3 mb-4">
                        <span class="text-muted fw-light">انبار و تامین /</span>
                        سرجمع سفارشات روزانه
                    </h4>
                    <!-- Sticky Actions -->
                    <form action="{{ route('deliveries.OutgoingFilter') }}" method="POST">
                        @csrf
...
<script>
    ...
    $('.anbarotozi .dayOrders').addClass('active open');
    // datatable (jquery)
    $(function () {
        var
