            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="row">
                        <div class="col">
                            <h4 class="py-3 mb-2">
                                <a href="{{ route('regions.index') }}" class="text-muted fw-light">مسیر ها /</a>
                                <span class="text-muted fw-light">{{ $Area->name }} /</span>
                                لیست مشتریان {{ Request::routeIs('areas.activeCustomersList') ? 'فعال' : '' }}
                            </h4>
                        </div>
                        <div class="col text-end">
                            <a href="{{ route('areas.index') }}" class="btn btn-label-dark waves-effect ms-3 mt-2" type="button">
                                بازگشت
