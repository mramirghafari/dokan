...
<head>
    ...
    <title>مدیریت انبارهای مواد اولیه - دکان دارمینو</title>
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row mt-5">
                        <div class="col-12 col-md-4 order-1 order-lg-2 mb-4 mb-lg-0">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <form action="{{ route('MaterialStores.store') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                            <label class="form-label" for="title">عنوان انبار</label>
                                            <input class="form-control" id="title" placeholder="عنوان انبار" type="text" name="title" required/>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="description">توضیحات انبار</label>
                                            <input class="form-control" id="description" placeholder="توضیح" type="text"  name="description" required/>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        @foreach ($stores as $store)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('MaterialStores.destroy', $store->id) }}"
                                                        method="POST"
...
<script>
    ...
    $('.materials .stores').addClass('active open')
    $(function () {
        var
