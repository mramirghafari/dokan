...
<head>
    ...
    <title>مدیریت شهرهای سامانه - دکان دارمینو</title>
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row mt-5">
                        <div class="col-12 order-1 order-lg-2 mb-4 mb-lg-0">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <form action="{{ route('cities.store') }}" class="row" method="POST">
                                        @csrf
                                        <div class="mb-3 col-12 col-md-4">
                                            <label class="form-label" for="name">نام شهر</label>
                                            <input class="form-control" id="name" placeholder="نام شهر" name="name" required type="text"/>
                                        </div>
                                        <div class="mb-3 col-12 col-md-4">
                                        ...
                                        <button class="btn btn-primary" type="submit">ایجاد شهر</button>
                                    </form>
                                </div>
                            </div>
                        </div>
