...
<head>
    ...
    <title>مدیریت مواد اولیه - دکان دارمینو</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row mt-5">
                        <div class="pt-4 mb-3">
                            <a href="{{ route('Materials.create') }}" class="btn btn-primary me-sm-3 me-1" type="submit">ثبت ماده اولیه</a>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-datatable table-responsive py-0">
                                    <table class="datatables-direct-basic table">
                                        ...
                                        <tr>
                                            <td><bdi>{{ $x }}</bdi></td>
                                            <td><a href="{{ route('products.edit',$material->id) }}">{{ $material->title }} {{ $material->display_name }}</a></td>
                                            <td>{{ $material->pr_unit }}</td>
                                            <td>{{ $material->pr_sub_unit }}</td>
