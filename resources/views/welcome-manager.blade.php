                                                ...
                                                <tr>
                                                    <td>
                                                        <button
                                                            ...
                                                            <strong class="text-dark">{{ count($MyLeaders) }}</strong>
                                                        </button>
                                                        <a href="{{ route('tasks.MyTasks') }}"
                                                            ...
                                                            <span class="text-dark">
                                                                ...
                                                                مسیر های فعال: </span>
                                                            <strong class="text-dark">{{ $ActiveTasks }} مسیر
                                                            </strong>
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <button
                                                            ...
                                                            <strong
                                                                class="text-dark">{{ isset($Target) ? $Target->start_date_fa : 'ندارد' }}</strong>
                                                        </button>
                                                        <button
                                                            class="btn btn-label-secondary waves-effect w-100 d-flex justify-content-between mb-2"
                                                            type="button">
                                                            ...
                                                            <strong
                                                                class="text-dark">{{ isset($Target) ? $Target->end_date_fa : 'ندارد' }}</strong>
                                                        </button>
                                                        <a href="{{ route('tasks.MyTasks') }}"
                                                            class="btn btn-label-secondary waves-effect w-100 d-flex justify-content-between">
                                                            <span class="text-dark">
                                    ...
                                    <div class="table-responsive">
                                        <div class="text-center px-3">
                                            <circle-progress text-format="vertical" indeterminateText="تارگت شما"
                                                max="{{ isset($Target) ? $Target->target_price : 0 }}"
                                            ...
                                            <p class="text-warning" style="font-size: 13px">
                                                هنوز
                                                <strong>{{ isset($Target) ? verta("$Target->end_date_en")->diffDays() : 0 }}</strong>
                                        ...
                                        <div class="card green m-3">
                                            <div class="card-header py-2" style="background-color: #248230">
                                                <div class="card-title mb-0 text-white text-center">
                                                    تارگت این ماه: <strong
                                                        style="font-size: 18px">{{ isset($Target) ? number_format($Target->target_price) : 0 }}</strong>
                                                    <small>ریال</small>
                                                </div>
                                            </div>
                                            <div class="card-body  pb-0"
                                                ...
                                                @if ($Target)
                                                    <?php $Mande = intval($Target->target_price) - intval($AllFactorPrices); ?>
                                    ...
                                    <div class="card-header d-flex justify-content-between py-3">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-0">
                                                ...
                                                وضعیت سرپرست ها @if ($Target)
                                                    <small>در بازه ی زمانی تارگت</small>
                                                @endif
                                            </h5>
                                        </div>
                                                ...
                                                @foreach ($MyLeaders as $leader)
                                                    <tr>
                                                        ...
                                                        <td><small data-bs-toggle="tooltip" data-bs-placement="top"
                                                                ...
                                                                data-bs-title="{{ $leader['name'] }}"><a
                                                                    href="{{ route('userInvoiceList', $leader['id']) }}">{{ strlen($leader['name']) > 12 ? mb_substr($leader['name'], 0, 15, 'UTF-8') . '...' : $leader['name'] }}</small>
                                                        </td>
                                                        <td><small>{{ $leader['username'] }}</small></small></td>
                                                        <td>
                                                            <?php
                                                            $leaderTasks = DB::table('tasks')->where('leader_id', $leader['id'])->pluck('area_id');
                                                            $leaderAreas = DB::table('areas')->whereIn('id', $leaderTasks)->pluck('id');
                                                            $leaderCustomersCount = DB::table('customers')->whereIn('area', $leaderAreas)->count();
                                                            ?>
                                                            <small>{{ $leaderCustomersCount }}</small>

                                                        </td>
                                                        <td>
                                                            <small>{{ $leader['factors_count'] }}</small>
                                                        </td>
                                                        <td><small>{{ number_format($leader['FactorPrices']) }}</small>
                                                        </td>
                                                        <td>
                                                            @if ($leader['isActive'] == 1)
                                            ...
                                            <tbody style="background-color: #fff">
                                                ...
                                                @foreach ($topVisitors as $visitor)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                            $VisitorTasks = DB::table('tasks')->where('user_id', $visitor->visitor_id)->pluck('area_id');
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($Factors as $factor)
                                                    <tr>
                                                        <th>{{ $x }}</th>
                                                        <td class="big">
                                                            <small>{{ $factor->customer->customer_code }}</small></td>
                                                        <td class="big">
                                                        ...
                                                        <td class="big"><small>{{ $factor->recive_date }}</small>
                                                        </td>
                                                        <td>
        ...
        $(function() {
            ...
            if (dt_without_ajax_table.length) {
                dt_without_ajax = dt_without_ajax_table.DataTable({
                    ...
                    ordering: false,
                    pageLength: 25,
                    autoWidth: false, // جلوگیری از override دیتاتیبل
                    columnDefs: [{
                            targets: 0,
                            width: '50px',
