                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-sm-12 order-1 order-lg-2 mb-4 mb-lg-0">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-datatable table-responsive purplebox tablelist marketer-status-table-wrap py-0">
                                        <table class="datatables-direct-basic purple table marketer-status-table">
                                            <thead>
                                                <tr>
                                                    <th width="20">#</th>
                                                    <th>نام بازاریاب</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="name-col"><small data-bs-toggle="tooltip" data-bs-placement="top"
                                                                ...
                                                                data-bs-title="{{ $visitor['name'] }}"><a
                                                                    href="{{ route('userInvoiceList', $visitor['id']) }}">{{ $visitor['name'] }}</a>
                                                            </small></td>
