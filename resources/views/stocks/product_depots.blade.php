                                ...
                                <div class="card-datatable table-responsive py-0">
                                    <table class="datatables-direct-basic table">
                                        ...
                                        <tr>
                                            ...
                                            <th>نوع</th>
                                            <th>واحد اصلی <small class="text-muted">({{ $Product->pr_unit }})</small></th>
                                            <th>واحد فرعی <small class="text-muted">({{ $Product->pr_sub_unit }})</small></th>
                                        ...
                                        @foreach($Depots as $depot)
                                            <tr>
                                                ...
                                                <td>{{ Verta($depot->created_at)->format('Y-m-d-H:i:s') }}</td>
                                            </tr>
                                            @php($x++)
                                        @endforeach
                                        </tbody>
...
<script>
    ...
    $(function () {
        ...
        $('#entity').on('keyup',function() {
            var entity = $(this).val();
            var pack_items = {{ $Product->pack_items }};
            var sub_unit = entity / pack_items;
            $('#entity_sub_unit').val(sub_unit);
        });

        $('#entity_sub_unit').on('keyup',function() {
            var entity_sub = $(this).val();
            var pack_items = {{ $Product->pack_items }};
            var unit = entity_sub * pack_items;
            $('#entity').val(unit);
        });
