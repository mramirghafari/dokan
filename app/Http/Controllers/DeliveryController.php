...
class DeliveryController extends Controller
{
    ...
    public function storeShipments(Request $request)
    {
        ...
        $user = \Auth::user();
        ActivityLogService::safeLog('create', 'ثبت سفر جدید', null, ['section' => 'system', 'event_key' => 'system.create']);
    ...
    public function store(Request $request)
    {
        ...
        for ($i = 0; $i <= ($request->total_item - 1); $i++) {
            ...
            ActivityLogService::safeLog('create', 'تحویل کالا انجام شد' . '-' . $delivery->employee->name, null, ['section' => 'system', 'event_key' => 'system.create']);
        }
    ...
    public function update(Request $request, Delivery $delivery)
    {
        ...
        if ($request['product_id'] != $delivery->product_id) {
            ...
            ActivityLogService::safeLog('update', 'تحویل کالا ویرایش شد' . '-' . $delivery->employee->name, null, ['section' => 'system', 'event_key' => 'system.update']);
    ...
    public function destroy(Delivery $delivery)
    {
        ...
        $history->delete();
        $delivery->delete();
        ActivityLogService::safeLog('create', 'تحویل کالا حذف شد' . '-' . $delivery->employee->name, null, ['section' => 'system', 'event_key' => 'system.create']);
