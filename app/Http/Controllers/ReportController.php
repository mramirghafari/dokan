...
class ReportController extends Controller
{
    ...
    public function managementTemplateStore(Request $request)
    {
        ...
        ActivityLogService::safeLog('create', 'managementTemplateStore', null, ['section' => 'report', 'event_key' => 'report.managementTemplateStore']);
    ...
    public function managementScheduleStore(Request $request)
    {
        ...
        ActivityLogService::safeLog('create', 'managementScheduleStore', null, ['section' => 'report', 'event_key' => 'report.managementScheduleStore']);
