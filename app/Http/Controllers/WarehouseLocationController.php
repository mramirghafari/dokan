...
class WarehouseLocationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ActivityLogService::safeLogModel('create', 'مکان انبار ایجاد شد' . '-' . $location->title, $location, ['section' => 'system', 'event_key' => 'location.create']);
    ...
    public function update(Request $request, WarehouseLocation $warehouse_location)
    {
        ...
        ActivityLogService::safeLogModel('update', 'مکان انبار ویرایش شد' . '-' . $location->title, $location, ['section' => 'system', 'event_key' => 'location.update']);
