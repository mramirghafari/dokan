...
class MaterialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = \Auth::user();
        ActivityLogService::safeLogModel('create', 'ماده اولیه ایجاد شد' . '-' . $Material->name, $Material, ['section' => 'warehouse', 'event_key' => 'material.create']);
...
//        dd($request->all());
        ...
        $user = \Auth::user();
        ActivityLogService::safeLogModel('update', 'ماده اولیه ویرایش شد' . '-' . $material->name, $material, ['section' => 'warehouse', 'event_key' => 'material.update']);
