...
class FactorSettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = \Auth::user();
        ActivityLogService::safeLogModel('create', 'تنظیمات فاکتور توسط ' . $user->name . ' ایجاد شد' . '-' . $Factor->name, $Factor, ['section' => 'invoice', 'event_key' => 'factor_setting.created']);
    ...
    public function update(Request $request, $id)
    {
        ...
        $user = \Auth::user();
        ActivityLogService::safeLogModel('update', 'تنظیمات فاکتور ویرایش شد' . '-' . $factorMaker->name, $factorMaker, ['section' => 'system', 'event_key' => 'factormaker.update']);
