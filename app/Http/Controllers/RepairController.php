...
class RepairController extends Controller
{
    ...
    public function store(RepairRequest $request)
    {
        ...
        ActivityLogService::safeLogModel('create', 'یک کالا جهت تعمیر ایجاد شد' . '-' . $repair->title, $repair, ['section' => 'warehouse', 'event_key' => 'repair.create']);
    ...
    public function update(RepairRequest $request, Repair $repair)
    {
        ...
        ActivityLogService::safeLogModel('create', 'کالای تعمیری ویرایش شد' . '-' . $repair->title, $repair, ['section' => 'warehouse', 'event_key' => 'repair.create']);
