...
class AreaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = Auth::user();
        ActivityLogService::safeLogModel('create', 'منطقه ایجاد شد' . '-' . $Area->name, $Area, ['section' => 'sales', 'event_key' => 'area.create']);
    ...
    public function update(Request $request, Area $area)
    {
        ...
        $user = Auth::user();
        ActivityLogService::safeLogModel('update', 'مسیر ویرایش شد' . '-' . $area->title, $area, ['section' => 'sales', 'event_key' => 'area.update']);
    ...
    public function destroy($id)
    {
        ...
        ActivityLogService::safeLogModel('delete', ' مسیر توسط ' . $user->name . ' حذف شد' . '-' . $Area->title, $Area, ['section' => 'sales', 'event_key' => 'area.deleted']);
