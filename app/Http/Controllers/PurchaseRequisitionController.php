...
class PurchaseRequisitionController extends Controller
{
    ...
    public function storeFromReorder(Request $request, InventoryReorderReportService $service)
    {
        ...
        ActivityLogService::safeLog('create', 'From Reorder', null, ['section' => 'procurement', 'event_key' => 'procurement.storeFromReorder']);
    ...
    public function storeQuotation(Request $request, PurchaseRequisition $purchaseRequisition)
    {
        ...
        ActivityLogService::safeLog('create', 'Quotation', null, ['section' => 'procurement', 'event_key' => 'procurement.storeQuotation']);
