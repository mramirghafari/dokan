...
class InvoiceController extends Controller
{
    ...
    public function add_factor_visitor(Request $request)
    {
        ...
        Log::create([
            ...
            'user_id' => $user->id,
            'action' => 'create',
            'description' => "پیش فاکتور جدیدی توسط" . $user->name . "ایجاد شد"
        ]);
    ...
    public function UpdateFactorItems(Request $request, Pishfactor $PishFactor)
    {
        ...
        Log::create([
            ...
            'user_id' => $user->id,
            'action' => 'update',
            'description' => "به روزرسانی لیست اجناس فاکتور توسط $user->name;"
        ]);
    ...
    public function pishFactorUpdate(Request $request, Pishfactor $PishFactor)
    {
        ...
        Log::create([
            ...
            'user_id' => $user->id,
            'action' => 'update',
            'description' => "به روزرسانی فاکتور توسط $user->name;"
        ]);
    ...
    public function DeleteFactor(Pishfactor $PishFactor)
    {
        ...
        Log::create([
            ...
            'user_id' => $user->id,
            'action' => 'delete',
            'description' => 'فاکتور حذف شد' . '-' . $PishFactor->invoiceID
        ]);
