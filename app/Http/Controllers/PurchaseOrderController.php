...
class PurchaseOrderController extends Controller
{
    ...
    public function storeForeignImport(Request $request, ForeignPurchaseOrderService $foreignPurchaseOrderService)
    {
        ...
        ActivityLogService::safeLog('create', 'Foreign Import', null, ['section' => 'procurement', 'event_key' => 'procurement.storeForeignImport']);
    ...
    public function updateForeignImportStatus(Request $request, ForeignPurchaseOrder $foreignPurchaseOrder, ForeignPurchaseOrderService $foreignPurchaseOrderService)
    {
        ...
        ActivityLogService::safeLog('update', 'Foreign Import Status', null, ['section' => 'procurement', 'event_key' => 'procurement.updateForeignImportStatus']);
    ...
    public function storeServiceInvoice(Request $request, PurchaseServiceInvoiceService $serviceInvoiceService)
    {
        ...
        ActivityLogService::safeLog('create', 'Service Invoice', null, ['section' => 'procurement', 'event_key' => 'procurement.storeServiceInvoice']);
    ...
    public function cancelServiceInvoice(PurchaseServiceInvoice $purchaseServiceInvoice, PurchaseServiceInvoiceService $serviceInvoiceService)
    {
        ...
        ActivityLogService::safeLog('delete', 'Service Invoice', null, ['section' => 'procurement', 'event_key' => 'procurement.cancelServiceInvoice']);
    ...
    public function storeBudget(Request $request)
    {
        ...
        ActivityLogService::safeLog('create', 'Budget', null, ['section' => 'procurement', 'event_key' => 'procurement.storeBudget']);
    ...
    public function storeDirectSupply(Request $request, PurchaseApprovalService $purchaseApprovalService)
    {
        ...
        ActivityLogService::safeLog('create', 'Direct Supply', null, ['section' => 'procurement', 'event_key' => 'procurement.storeDirectSupply']);
    ...
    public function store(Request $request)
    {
        ...
        ActivityLogService::safeLog('create', 'store', null, ['section' => 'procurement', 'event_key' => 'procurement.store']);
    ...
    public function approveApproval(Request $request, PurchaseOrder $purchaseOrder, PurchaseApprovalService $purchaseApprovalService)
    {
        ...
        ActivityLogService::safeLog('update', 'Approval', null, ['section' => 'procurement', 'event_key' => 'procurement.approveApproval']);
    ...
    public function approve(PurchaseOrder $purchaseOrder, PurchaseOrderService $purchaseOrderService)
    {
        ...
        if ($purchaseOrder->status === 'canceled') {
            ActivityLogService::safeLog('update', 'approve', null, ['section' => 'procurement', 'event_key' => 'procurement.approve']);
    ...
    public function storePurchaseInvoice(Request $request, PurchaseOrder $purchaseOrder, PurchaseInvoiceService $purchaseInvoiceService)
    {
        ...
        ActivityLogService::safeLog('create', 'Purchase Invoice', null, ['section' => 'procurement', 'event_key' => 'procurement.storePurchaseInvoice']);
