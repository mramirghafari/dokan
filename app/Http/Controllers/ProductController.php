...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ActivityLogService::safeLogModel('create', 'یک محصول ایجاد شد' . '-' . $product->title, $product, ['section' => 'product', 'event_key' => 'product.create']);
    ...
    public function update(Request $request, Product $product)
    {
        ...
        //Stores
        $user = Auth::user();
        ActivityLogService::safeLogModel('update', 'محصول ویرایش شد' . '-' . $product->title, $product, ['section' => 'product', 'event_key' => 'product.update']);
    ...
    public function update_product_fees(Request $request)
    {
        ...
        ActivityLogService::safeLog('create', 'به روزرسانی قیمت روز محصولات انجام شد', null, ['section' => 'system', 'event_key' => 'system.create']);
