...
class AccountingController extends Controller
{
    ...
    public function storeRevenueCenter(Request $request)
    {
        ...
        $center = RevenueCenter::create(array_merge($payload, [
        ...
        $this->logAccounting('create', 'ایجاد مرکز درآمد: ' . $center->name, $center, 'revenue_center.created');
    ...
    public function storeIncomeType(Request $request)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Income Type', null, 'accounting.storeIncomeType');
    ...
    public function storeIncome(Request $request, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Income', null, 'accounting.storeIncome');
    ...
    public function storeIncomeAttachment(Request $request, OperationalIncome $income)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Income Attachment', null, 'accounting.storeIncomeAttachment');
    ...
    public function storeCurrency(Request $request)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Currency', null, 'accounting.storeCurrency');
    ...
    public function storeExchangeRate(Request $request)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Exchange Rate', null, 'accounting.storeExchangeRate');
    ...
    public function closeFiscalYear(FiscalYear $fiscalYear, AccountingPeriodClosingService $service)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Fiscal Year', null, 'accounting.closeFiscalYear');
    ...
    public function storeCostCenter(Request $request)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Cost Center', null, 'accounting.storeCostCenter');
    ...
    public function storeExpenseType(Request $request)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Expense Type', null, 'accounting.storeExpenseType');
    ...
    public function storeSpecializedExpense(Request $request)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Specialized Expense', null, 'accounting.storeSpecializedExpense');
    ...
    public function approveSpecializedExpense(OperationalExpense $expense, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('update', 'تایید هزینه اختصاصی: ' . $expense->expense_number, $expense, 'expense.approved');
    ...
    public function rejectSpecializedExpense(Request $request, OperationalExpense $expense)
    {
        ...
        $this->logAccounting('update', 'رد هزینه اختصاصی: ' . $expense->expense_number, $expense, 'expense.rejected');
    ...
    public function storeExpense(Request $request, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Expense', null, 'accounting.storeExpense');
    ...
    public function storeExpenseAttachment(Request $request, OperationalExpense $expense)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Expense Attachment', null, 'accounting.storeExpenseAttachment');
    ...
    public function storeCompanyAsset(Request $request)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Company Asset', null, 'accounting.storeCompanyAsset');
    ...
    public function storeCompanyAssetAttachment(Request $request, CompanyAsset $companyAsset)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Company Asset Attachment', null, 'accounting.storeCompanyAssetAttachment');
    ...
    public function storeCompanyAssetEvent(Request $request, CompanyAsset $companyAsset)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Company Asset Event', null, 'accounting.storeCompanyAssetEvent');
    ...
    public function postCompanyAssetDepreciation(Request $request, FixedAssetDepreciationService $depreciationService)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Company Asset Depreciation', null, 'accounting.postCompanyAssetDepreciation');
    ...
    public function storeCompanyAssetDepreciationPolicy(Request $request, CompanyAsset $companyAsset)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Company Asset Depreciation Policy', null, 'accounting.storeCompanyAssetDepreciationPolicy');
    ...
    public function postCompanyAssetCapitalAddition(Request $request, CompanyAsset $companyAsset, FixedAssetCapitalAdditionService $capitalAdditionService)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Company Asset Capital Addition', null, 'accounting.postCompanyAssetCapitalAddition');
    ...
    public function postCompanyAssetDisposal(Request $request, CompanyAsset $companyAsset, FixedAssetDisposalService $disposalService)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Company Asset Disposal', null, 'accounting.postCompanyAssetDisposal');
    ...
    public function updateCompanyAssetTaxInvoiceStatus(Request $request, CompanyAssetTaxInvoice $taxInvoice, FixedAssetTaxInvoiceService $taxInvoiceService)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Company Asset Tax Invoice Status', null, 'accounting.updateCompanyAssetTaxInvoiceStatus');
    ...
    public function storePayrollContract(Request $request, PayrollService $payrollService)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Payroll Contract', null, 'accounting.storePayrollContract');
    ...
    public function storePayrollAttendance(Request $request, PayrollService $payrollService)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Payroll Attendance', null, 'accounting.storePayrollAttendance');
    ...
    public function storePayrollRun(Request $request, PayrollService $payrollService)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Payroll Run', null, 'accounting.storePayrollRun');
    ...
    public function payPayrollRun(Request $request, PayrollRun $payrollRun, PayrollService $payrollService)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Payroll Run', null, 'accounting.payPayrollRun');
    ...
    public function cancelPayrollRun(PayrollRun $payrollRun, PayrollService $payrollService)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Payroll Run', null, 'accounting.cancelPayrollRun');
    ...
    public function storeOpeningVoucher(Request $request, OpeningVoucherService $service)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Opening Voucher', null, 'accounting.storeOpeningVoucher');
    ...
    public function storeVoucher(Request $request, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('create', 'ایجاد سند حسابداری: ' . $voucher->voucher_number, $voucher, 'voucher.created');
    ...
    public function updateVoucher(Request $request, Voucher $voucher, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('update', 'ویرایش سند حسابداری: ' . $updated->voucher_number, $updated, 'voucher.updated');
    ...
    public function mergeVouchers(Request $request, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Vouchers', null, 'accounting.mergeVouchers');
    ...
    public function storeVoucherTemplate(Request $request, Voucher $voucher, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Voucher Template', null, 'accounting.storeVoucherTemplate');
    ...
    public function storeTreasury(Request $request, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Treasury', null, 'accounting.storeTreasury');
    ...
    public function storeTreasuryTransfer(Request $request, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Treasury Transfer', null, 'accounting.storeTreasuryTransfer');
    ...
    public function storeChequeBook(Request $request, TreasuryChequeBookService $service)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Cheque Book', null, 'accounting.storeChequeBook');
    ...
    public function storeBankStatementLine(Request $request)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Bank Statement Line', null, 'accounting.storeBankStatementLine');
    ...
    public function reconcileBankStatementLine(Request $request, BankStatementLine $line)
    {
        ...
        if ($action === 'match') {
            ...
            $this->logAccounting('update', 'عملیات حسابداری: Bank Statement Line', null, 'accounting.reconcileBankStatementLine');
    ...
    public function storePettyCashFund(Request $request, PettyCashService $service)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Petty Cash Fund', null, 'accounting.storePettyCashFund');
    ...
    public function chargePettyCash(Request $request, PettyCashFund $fund, PettyCashService $service)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Petty Cash', null, 'accounting.chargePettyCash');
    ...
    public function spendPettyCash(Request $request, PettyCashFund $fund, PettyCashService $service)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Petty Cash', null, 'accounting.spendPettyCash');
    ...
    public function settlePettyCash(Request $request, PettyCashFund $fund, PettyCashService $service)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Petty Cash', null, 'accounting.settlePettyCash');
    ...
    public function updateTreasuryInstrumentStatus(Request $request, TreasuryInstrument $instrument, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Treasury Instrument Status', null, 'accounting.updateTreasuryInstrumentStatus');
    ...
    public function makeVoucherPermanent(Voucher $voucher, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Voucher Permanent', null, 'accounting.makeVoucherPermanent');
    ...
    public function reverseVoucher(Request $request, Voucher $voucher, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Voucher', null, 'accounting.reverseVoucher');
    ...
    public function cancelVoucher(Request $request, Voucher $voucher, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('update', 'عملیات حسابداری: Voucher', null, 'accounting.cancelVoucher');
    ...
    public function copyVoucher(Request $request, Voucher $voucher, AccountingPostingService $postingService)
    {
        ...
        $this->logAccounting('create', 'عملیات حسابداری: Voucher', null, 'accounting.copyVoucher');
    ...
    private function logAccounting(string $action, string $description, $source = null, ?string $eventKey = null): void
    {
        $context = [
            'section' => 'accounting',
            'event_key' => $eventKey ?? ('accounting.' . $action),
        ];
