...
class AbortionController extends Controller
{
    ...
    public function store(AbortionRequest $request)
    {
        ...
        ActivityLogService::safeLogModel('create', 'یک کالای اسقاطی ایجاد شد' . '-' . $abortion->title, $abortion, ['section' => 'warehouse', 'event_key' => 'abortion.create']);
    ...
    public function update(AbortionRequest $request, Abortion $abortion)
    {
        ...
        ActivityLogService::safeLogModel('create', 'کالای اسقاطی ویرایش شد' . '-' . $abortion->title, $abortion, ['section' => 'warehouse', 'event_key' => 'abortion.create']);
