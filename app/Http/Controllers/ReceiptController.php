...
class ReceiptController extends Controller
{
    ...
    public function approveReceipt(Request $request, Receipt $receipt)
    {
        ...
        Log::create([
            ...
            'action' => 'approve',
            'section' => 'store',
            'description' => "سند انبار شماره " . ($receipt->number ?: $receipt->id) . " تایید شد.",
        ]);
    ...
    public function cancelReceipt(Request $request, Receipt $receipt)
    {
        ...
        Log::create([
            ...
            'action' => 'cancel',
            'section' => 'store',
            'description' => "سند انبار شماره " . ($receipt->number ?: $receipt->id) . " ابطال شد.",
        ]);
    ...
    public function returnReceipt(Request $request, Receipt $receipt)
    {
        ...
        Log::create([
            ...
            'action' => 'create',
            'section' => 'store',
            'description' => 'سند برگشت انبار شماره ' . ($returnReceipt->number ?: $returnReceipt->id) . ' از سند ' . ($receipt->number ?: $receipt->id) . ' ثبت شد.',
        ]);
