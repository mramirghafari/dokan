...
class MaterialStoreController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = \Auth::user();
        ActivityLogService::safeLogModel('create', 'انبار مواد اولیه ایجاد شد' . '-' . $store->title, $store, ['section' => 'warehouse', 'event_key' => 'store.create']);
    ...
    public function update(Request $request, Store $store)
    {
        ...
        $store->roles()->sync($request->roles);
        $user = \Auth::user();
        ActivityLogService::safeLogModel('update', 'انبار ویرایش شد' . '-' . $store->title, $store, ['section' => 'warehouse', 'event_key' => 'store.update']);
    ...
    public function destroy($id)
    {
        ...
        ActivityLogService::safeLogModel('delete', ' انبار مواد اولیه توسط '.$user->name.' حذف شد' . '-' . $MaterialStore->title, $MaterialStore, ['section' => 'warehouse', 'event_key' => 'material_store.deleted']);
