...
class StockController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ActivityLogService::safeLogModel('create', 'ثبت تولید و موجودی جدید محصول ایجاد شد' . '-' . $Product->title, $Product, ['section' => 'product', 'event_key' => 'product.create']);
    ...
    public function update(StockRequest $request, Stock $stock)
    {
        ...
        ActivityLogService::safeLogModel('update', 'کالا ویرایش شد' . '-' . $stock->title, $stock, ['section' => 'warehouse', 'event_key' => 'stock.updated']);
    ...
    public function storeInventoryAdjustment(Request $request, InventoryAdjustmentService $service)
    {
        ...
        ActivityLogService::safeLog('create', 'Inventory Adjustment', null, ['section' => 'warehouse', 'event_key' => 'warehouse.storeInventoryAdjustment']);
    ...
    public function approveInventoryAdjustment(InventoryAdjustment $adjustment, InventoryAdjustmentService $service)
    {
        ...
        ActivityLogService::safeLog('update', 'Inventory Adjustment', null, ['section' => 'warehouse', 'event_key' => 'warehouse.approveInventoryAdjustment']);
    ...
    public function cancelInventoryAdjustment(InventoryAdjustment $adjustment, InventoryAdjustmentService $service)
    {
        ...
        ActivityLogService::safeLog('delete', 'Inventory Adjustment', null, ['section' => 'warehouse', 'event_key' => 'warehouse.cancelInventoryAdjustment']);
    ...
    public function storeProductionFormula(Request $request)
    {
        ...
        ActivityLogService::safeLog('create', 'Production Formula', null, ['section' => 'warehouse', 'event_key' => 'warehouse.storeProductionFormula']);
    ...
    public function cancelProductionOrder(ProductionOrder $productionOrder, ProductionService $service)
    {
        ...
        ActivityLogService::safeLog('delete', 'Production Order', null, ['section' => 'warehouse', 'event_key' => 'warehouse.cancelProductionOrder']);
