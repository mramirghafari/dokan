...
class DistributionController extends Controller
{
    ...
    public function storeVisitPlan(Request $request, DistributionSalesService $distributionSales)
    {
        ...
        ActivityLogService::safeLog('create', 'Visit Plan', null, ['section' => 'sales', 'event_key' => 'sales.storeVisitPlan']);
    ...
    public function storePromotion(Request $request)
    {
        ...
        ActivityLogService::safeLog('create', 'Promotion', null, ['section' => 'sales', 'event_key' => 'sales.storePromotion']);
