...
class CrmCallCenterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ActivityLogService::safeLogModel('create', 'ثبت تماس CRM: ' . $callLog->subject, $callLog, ['section' => 'crm', 'event_key' => 'crm.call.created']);
    ...
    public function updateOutcome(Request $request, CrmCallLog $callLog)
    {
        ...
        ActivityLogService::safeLog('update', 'CRM: Outcome', null, ['section' => 'crm', 'event_key' => 'crm.updateOutcome']);
