...
class TargetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ActivityLogService::safeLog('create', "تارگت جدید برای کاربران ایجاد شد.", null, ['section' => 'system', 'event_key' => 'system.create']);
    ...
    public function update(Request $request, Targets $Target)
    {
        ...
        $user = \Auth::user();
        ActivityLogService::safeLog('update', 'تارگت ویرایش شد', null, ['section' => 'system', 'event_key' => 'system.update']);
