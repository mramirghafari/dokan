...
class UnitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ActivityLogService::safeLogModel('create', 'واحد ایجاد شد' . '-' . $unit->title, $unit, ['section' => 'product', 'event_key' => 'unit.create']);
    ...
    public function update(Request $request, Unit $unit)
    {
        ...
        ActivityLogService::safeLogModel('update', 'واحد ویرایش شد' . '-' . $unit->title, $unit, ['section' => 'product', 'event_key' => 'unit.update']);
