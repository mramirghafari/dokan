...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ActivityLogService::safeLogModel('create', 'سطح دسترسی ایجاد شد' . '-' . $permission->description, $permission, ['section' => 'roles', 'event_key' => 'permission.create']);
    ...
    public function update(Request $request, Permission $permission)
    {
        ...
        $permissions = $scopeService->permissionsForUser(auth()->user())->orderBy('description')->get();
        ActivityLogService::safeLogModel('update', 'سطح دسترسی ویرایش شد' . '-' . $permission->description, $permission, ['section' => 'roles', 'event_key' => 'permission.update']);
