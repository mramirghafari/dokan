...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = \Auth::user();
        ActivityLogService::safeLogModel('create', 'دسته بندی ایجاد شد' . '-' . $category->title, $category, ['section' => 'product', 'event_key' => 'category.create']);
    ...
    public function update(Request $request, Category $category)
    {
        ...
        $user = \Auth::user();
        ActivityLogService::safeLogModel('update', 'دسته بندی ویرایش شد' . '-' . $category->title, $category, ['section' => 'product', 'event_key' => 'category.update']);
